...
SENSOR_LIST = {
    ...
    # Temperature
    "tempf": {"name": "Outdoor Temperature", "icon": "mdi:thermometer", "unit": UnitOfTemperature.FAHRENHEIT, "device_class": SensorDeviceClass.TEMPERATURE, "state_class": SensorStateClass.MEASUREMENT, "precision": 1},
    "indoortempf": {"name": "Indoor Temperature", "icon": "mdi:thermometer", "unit": UnitOfTemperature.FAHRENHEIT, "device_class": SensorDeviceClass.TEMPERATURE, "state_class": SensorStateClass.MEASUREMENT, "precision": 1},
    "dewptf": {"name": "Dew Point", "icon": "mdi:thermometer", "unit": UnitOfTemperature.FAHRENHEIT, "device_class": SensorDeviceClass.TEMPERATURE, "state_class": SensorStateClass.MEASUREMENT, "precision": 1},
    "windchillf": {"name": "Wind Chill", "icon": "mdi:thermometer", "unit": UnitOfTemperature.FAHRENHEIT, "device_class": SensorDeviceClass.TEMPERATURE, "state_class": SensorStateClass.MEASUREMENT, "precision": 1},
    "soiltempf": {"name": "Soil Temperature", "icon": "mdi:thermometer", "unit": UnitOfTemperature.FAHRENHEIT, "device_class": SensorDeviceClass.TEMPERATURE, "state_class": SensorStateClass.MEASUREMENT, "precision": 1},

    # Humidity
    "humidity": {"name": "Outdoor Humidity", "icon": "mdi:water-percent", "unit": PERCENTAGE, "device_class": SensorDeviceClass.HUMIDITY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0},
    "indoorhumidity": {"name": "Indoor Humidity", "icon": "mdi:water-percent", "unit": PERCENTAGE, "device_class": SensorDeviceClass.HUMIDITY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0},
    "soilmoisture": {"name": "Soil Moisture", "icon": "mdi:water-percent", "unit": PERCENTAGE, "device_class": SensorDeviceClass.HUMIDITY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0},
    "leafwetness": {"name": "Leaf Wetness", "icon": "mdi:water-percent", "unit": PERCENTAGE, "device_class": SensorDeviceClass.HUMIDITY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0},
    ...
    "dailyrainin": {"name": "Daily Rain", "icon": "mdi:weather-rainy", "unit": UnitOfLength.INCHES, "device_class": SensorDeviceClass.PRECIPITATION, "state_class": SensorStateClass.TOTAL_INCREASING, "precision": 1},
    "weeklyrainin": {"name": "Weekly Rain", "icon": "mdi:weather-rainy", "unit": UnitOfLength.INCHES, "device_class": SensorDeviceClass.PRECIPITATION, "state_class": SensorStateClass.TOTAL_INCREASING, "precision": 1},
    "monthlyrainin": {"name": "Monthly Rain", "icon": "mdi:weather-rainy", "unit": UnitOfLength.INCHES, "device_class": SensorDeviceClass.PRECIPITATION, "state_class": SensorStateClass.TOTAL_INCREASING, "precision": 1},
    "yearlyrainin": {"name": "Yearly Rain", "icon": "mdi:weather-rainy", "unit": UnitOfLength.INCHES, "device_class": SensorDeviceClass.PRECIPITATION, "state_class": SensorStateClass.TOTAL_INCREASING, "precision": 1},
    "t1rainra": {"name": "Rain Rate", "icon": "mdi:weather-rainy", "unit": UnitOfVolumetricFlux.MILLIMETERS_PER_HOUR, "device_class": SensorDeviceClass.PRECIPITATION_INTENSITY, "state_class": SensorStateClass.MEASUREMENT, "precision": 1},
    "t1rainhr": {"name": "Hourly Rainfall", "icon": "mdi:weather-rainy", "unit": UnitOfLength.MILLIMETERS, "device_class": SensorDeviceClass.PRECIPITATION, "state_class": SensorStateClass.TOTAL_INCREASING, "precision": 1},
    "t1raindy": {"name": "Daily Rainfall", "icon": "mdi:weather-rainy", "unit": UnitOfLength.MILLIMETERS, "device_class": SensorDeviceClass.PRECIPITATION, "state_class": SensorStateClass.TOTAL_INCREASING, "precision": 1},
    "t1rainwy": {"name": "Weekly Rainfall", "icon": "mdi:weather-rainy", "unit": UnitOfLength.MILLIMETERS, "device_class": SensorDeviceClass.PRECIPITATION, "state_class": SensorStateClass.TOTAL_INCREASING, "precision": 1},
    "t1rainmth": {"name": "Monthly Rainfall", "icon": "mdi:weather-rainy", "unit": UnitOfLength.MILLIMETERS, "device_class": SensorDeviceClass.PRECIPITATION, "state_class": SensorStateClass.TOTAL_INCREASING, "precision": 1},
    "t1rainyr": {"name": "Yearly Rainfall", "icon": "mdi:weather-rainy", "unit": UnitOfLength.MILLIMETERS, "device_class": SensorDeviceClass.PRECIPITATION, "state_class": SensorStateClass.TOTAL_INCREASING, "precision": 1},

    # 7002586 Type 2/3/4 Multi-Channel Sensors
    "soilmoisture2": {"name": "CH2 Soil Moisture", "icon": "mdi:water-percent", "unit": PERCENTAGE, "device_class": SensorDeviceClass.HUMIDITY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0},
    "soilmoisture3": {"name": "CH3 Soil Moisture", "icon": "mdi:water-percent", "unit": PERCENTAGE, "device_class": SensorDeviceClass.HUMIDITY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0},
    "soilmoisture4": {"name": "CH4 Soil Moisture", "icon": "mdi:water-percent", "unit": PERCENTAGE, "device_class": SensorDeviceClass.HUMIDITY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0},
    "soiltemp2f": {"name": "CH2 Soil Temperature", "icon": "mdi:thermometer", "unit": UnitOfTemperature.FAHRENHEIT, "device_class": SensorDeviceClass.TEMPERATURE, "state_class": SensorStateClass.MEASUREMENT, "precision": 1},
    "soiltemp3f": {"name": "CH3 Soil Temperature", "icon": "mdi:thermometer", "unit": UnitOfTemperature.FAHRENHEIT, "device_class": SensorDeviceClass.TEMPERATURE, "state_class": SensorStateClass.MEASUREMENT, "precision": 1},
    "soiltemp4f": {"name": "CH4 Soil Temperature", "icon": "mdi:thermometer", "unit": UnitOfTemperature.FAHRENHEIT, "device_class": SensorDeviceClass.TEMPERATURE, "state_class": SensorStateClass.MEASUREMENT, "precision": 1},
    "leafwetness2": {"name": "CH2 Leaf Wetness", "icon": "mdi:water-percent", "unit": PERCENTAGE, "device_class": SensorDeviceClass.HUMIDITY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0},
    ...
    # Sun / UV
    "solarradiation": {"name": "Solar Radiation", "icon": "mdi:weather-sunny", "unit": UnitOfIrradiance.WATTS_PER_SQUARE_METER, "device_class": SensorDeviceClass.IRRADIANCE, "state_class": SensorStateClass.MEASUREMENT, "precision": 0},
    "UV": {"name": "UV Index", "icon": "mdi:weather-sunny-alert", "unit": UV_INDEX, "device_class": None, "state_class": SensorStateClass.MEASUREMENT, "precision": 1},
    ...
    "t1bat": {"name": "Outdoor Sensor Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "inbat": {"name": "Console Battery Level", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "t234c1bat": {"name": "CH1 Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0,  "battery_scale": 1, "binary": "battery"},
    ...
    "t234c2bat": {"name": "CH2 Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "t234c3bat": {"name": "CH3 Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "t234c4bat": {"name": "CH4 Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "t234c5bat": {"name": "CH5 Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "t234c6bat": {"name": "CH6 Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "t234c7bat": {"name": "CH7 Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "t5lskm": {"name": "Lightning Distance", "icon": "mdi:map-marker-distance", "unit": UnitOfLength.KILOMETERS, "device_class": SensorDeviceClass.DISTANCE, "state_class": SensorStateClass.MEASUREMENT, "precision": 1},
    ...
    "t5lsbat": {"name": "Lightning Sensor Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "t6c1bat": {"name": "CH1 Water Leak Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "t6c2bat": {"name": "CH2 Water Leak Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "t6c3bat": {"name": "CH3 Water Leak Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "t6c4bat": {"name": "CH4 Water Leak Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "t6c5bat": {"name": "CH5 Water Leak Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "t6c6bat": {"name": "CH6 Water Leak Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "t6c7bat": {"name": "CH7 Water Leak Battery Status", "icon": "mdi:battery", "unit": PERCENTAGE, "device_class": SensorDeviceClass.BATTERY, "state_class": SensorStateClass.MEASUREMENT, "precision": 0, "battery_scale": 1, "binary": "battery"},
    ...
    "clouds": {"name": "Cloud Cover", "icon": "mdi:weather-cloudy", "unit": PERCENTAGE, "device_class": None, "state_class": SensorStateClass.MEASUREMENT, "precision": 0},
